            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="btn-group pull-right">
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="http://localhost:8081/codigofacilito/index.php/">
                            <i class="icon-user"></i> Jeysson<span class="caret"></span>
                        </a>
        ...
        <div class="container-fluid">
            ...
            <footer>
               <!-- <p>&copy; <?= $this->config->item('site_name') ?> <?= date('Y') ?></p>-->
                <p>Powered  Codeigniter Bootstrap v<?= $this->config->item('version') ?></p>
            </footer>
        </div>
